...
# Approach:
# 1. Create a HashMap to store anagrams where the key is the sorted version of each string, and the value is a list of anagrams.
...
# 3. After processing all strings, return a list containing the values (lists of anagrams) of the HashMap.
class Solution {
